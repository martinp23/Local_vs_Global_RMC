...
if show_hydrogens
    ...
    adjMat = distMat < 1.85; % cutoff for drawing bonds
...
color_list = [... % coloring for spectator atoms
    ...
    0.2980,0.4980,0.4980;
    0.1373,0.7451,0.1961;
    0.7137,0.7490,0.8118;
    0.2980,0.9980,0.4980;
    0.1373,0.4451,0.1961;
    0.7137,0.2490,0.8118;
    0.8471,0.4784,0.6941;
    0.4980,0.4980,0.4980;
    0.7373,0.7451,0.1961;
    0.1137,0.7490,0.8118;
